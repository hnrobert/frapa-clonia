...
public partial class ConfigPreset : ObservableObject
{
    ...
    /// </summary>
    [ObservableProperty] private FrpClientConfig _configuration = new();

    /// <summary>
    /// Deployment settings for this preset
    /// </summary>
    [ObservableProperty] private DeploymentSettings _deployment = new();
    ...
    private static FrpClientConfig CloneConfiguration(FrpClientConfig source)
    {
        ...
        {
            CommonConfig = source.CommonConfig != null
                ? new ClientCommonConfig
                {
                    Auth = source.CommonConfig.Auth != null
                        ? new AuthConfig
                        {
                            ...
                            Oidc = source.CommonConfig.Auth.Oidc != null
                                ? new AuthOIDCClientConfig
                                {
                                    ...
                                    AdditionalEndpointParams =
                                        source.CommonConfig.Auth.Oidc.AdditionalEndpointParams?.ToDictionary(
                    ...
                    Log = source.CommonConfig.Log != null
                        ? new LogConfig
                        {
                    ...
                    Transport = source.CommonConfig.Transport != null
                        ? new ClientTransportConfig
                        {
                            ...
                            Tls = source.CommonConfig.Transport.Tls != null
                                ? new TLSClientConfig
                                {
                                    Enable = source.CommonConfig.Transport.Tls.Enable,
                                    DisableCustomTLSFirstByte =
                                        source.CommonConfig.Transport.Tls.DisableCustomTLSFirstByte,
...
public partial class DeploymentSettings : ObservableObject
{
    ...
    /// </summary>
    [ObservableProperty] private string _deploymentMode = "native";
    ...
    /// </summary>
    [ObservableProperty] private string? _frpcVersion = "latest";

    // ReSharper disable once GrammarMistakeInComment
    /// <summary>
    /// Installation method: "auto", "github", "package_manager", "custom_path"
    /// </summary>
    [ObservableProperty] private string _installMethod = "auto";
    ...
    /// </summary>
    [ObservableProperty] private string? _selectedPackageManager;
    ...
    /// </summary>
    [ObservableProperty] private string _serviceScope = "user";
